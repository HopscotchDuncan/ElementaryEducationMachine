...
public class DrawingCreator {
    ...
    int savemanSpineStartX = 200;

    public Circle makeHead() {
        Circle head = new Circle(20);
        head.setTranslateX(savemanSpineStartX);
        return head;
    }

    public Line makeSpine() {
        Line spine = new Line();
        spine.setTranslateX(savemanSpineStartX + 19);
        setStart(spine);
    ...
    public Line makeLeftArm() {
        ...
        leftArm.setTranslateX(savemanSpineStartX - 2);
    ...
    public Line makeRightArm() {
        ...
        rightArm.setTranslateX(savemanSpineStartX + 20);
    ...
    public Line makeLeftLeg() {
        ...
        leftLeg.setTranslateX(savemanSpineStartX - 2);
    ...
    public Line makeRightLeg() {
        ...
        rightLeg.setTranslateX(savemanSpineStartX + 20);
